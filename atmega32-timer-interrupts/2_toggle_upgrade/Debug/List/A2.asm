...
_0x0:
	.DB  0x54,0x69,0x6D,0x65,0x72,0x30,0x20,0x56
	.DB  0x61,0x6C,0x75,0x65,0x3A,0x20,0x25,0x64
	.DB  0x0
_0x2000003:
	.DB  0x80,0xC0
...
; 0000 000D    if(pulse_enable==1)pulse_enable=0;
	SBRS R2,0
	RJMP _0x3
	CLT
	RJMP _0x13
; 0000 000E    else pulse_enable=1;
_0x3:
	SET
_0x13:
	BLD  R2,0
...
; 0000 0017      else{
_0x5:
; 0000 0018         if (PORTB.2==1)PORTB.2=0;
	SBIS 0x18,2
	RJMP _0x9
	CBI  0x18,2
; 0000 0019         else PORTB.2=1;
	RJMP _0xC
_0x9:
_0x14:
	SBI  0x18,2
...
_main:
; .FSTART _main
; 0000 001F char lcd_buffer[16];
; 0000 0020 unsigned char timer0;
...
; 0000 0036  // Compare A Match Interrupt: On
...
; 0000 003D  ICR1L=0x00;
	OUT  0x26,R30
; 0000 003E  OCR1AH=0x01;
	LDI  R30,LOW(1)
	OUT  0x2B,R30
; 0000 003F  OCR1AL=0xF3;
	LDI  R30,LOW(243)
	OUT  0x2A,R30
...
; 0000 0041  OCR1BL=0x00;
	OUT  0x28,R30
; 0000 0042  // External Interrupt(s) initialization
; 0000 0043  // INT0: On
; 0000 0044  // INT0 Mode: Falling Edge
; 0000 0045  // INT1: Off
; 0000 0046  // INT2: Off
; 0000 0047  GICR|=0x40;
	IN   R30,0x3B
...
; 0000 0054  timer0=TCNT0;
	IN   R17,50
; 0000 0055  lcd_clear();
	CALL _lcd_clear
; 0000 0056  sprintf(lcd_buffer,"Timer0 Value: %d",timer0);
	MOVW R30,R28
	ST   -Y,R31
	ST   -Y,R30
	__POINTW1FN _0x0,0
